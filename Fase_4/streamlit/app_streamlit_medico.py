...
predict_button = st.button("Obter Predição e Suporte")
...
if predict_button:
    ...
    try:
        ...
        if "GOOGLE_API_KEY" in st.secrets:
            ...
            st.warning("Não foi possível gerar Suporte a Decisão da IA Gemini. GOOGLE_API_KEY não configurada.")
            gemini_response_text = "Suporte da IA Gemini não disponíveis." # Default text if API not configured
